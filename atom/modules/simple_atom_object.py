...
from chemutils.Common.MolExt import (
    setSingleExplicitHydrogens,
    getAtmMappedSmilesFromCompositeSmiles,
)
...
class SimpleAtomObject(object):
    ...
    def __init__(self, oeAtom, oeMol, symmetricAtoms):
        ...
        self.connectedSmiles = getAtmMappedSmilesFromCompositeSmiles(
            self.fullSmiles, clearMaps=False
        )
