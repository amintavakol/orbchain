...
from chemutils.CombiCDB.proposers.Util import log, compatibleOrbitalPair, labelOrbPair
...
from chemutils.CombiCDB.proposers.PeriPattern import PeriPattern, defaultPeriPatterns

class PericyclicProposer(AtomBasedReactionProposer):
    """Reaction proposer 
    """
    def __init__(self, closureList, orbitalPairFilters=defaultFilters, periPatternObjs=None):
        """Constructor.  Setup the necessary pieces to propose
        """
        self.periPatterns = periPatternObjs
        self.closureList = closureList
        super(PericyclicProposer, self).__init__(closureList, closureList, orbitalPairFilters, checkResonance=False)
