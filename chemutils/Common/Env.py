...
FAILOVER_DB_PARAM["PWD"]  = None # Comment out this line to force user to enter password at runtime
...
DEV_DB_PARAM["PWD"]  = None; # Comment out this line to force user to enter password at runtime
